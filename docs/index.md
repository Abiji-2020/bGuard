...
<figure>
  <img src="https://raw.githubusercontent.com/Abiji-2020/bGuard/main/docs/bGuard.svg" width="200" />
</figure>

bGuard is a DNS proxy and ad-blocker for the local network written in Go with following features:
...
- **Security and Privacy** - :dark_sunglasses: Secure communication
    ...
    * bGuard does **NOT** collect any user data, telemetry, statistics etc.
...
- **Simple installation/configuration** - :cloud: bGuard was designed for simple installation
...
Issues, feature suggestions and pull requests are welcome! bGuard lives on :material-github:[GitHub](https://github.com/Abiji-2020/bGuard).
